...
<div class='row'>
    ...
    <div id="client-reviewed">
        <div class="col-sm-2">
            <img src="{{Request::root()}}/frontend/images/page/client.jpg" class="img-responsive" />
        </div>
        <div class="col-sm-10">
            <h2>The trip went brilliantly. Many thanks to all your staff involved.</h2>
            <p>
    ...
    <div class='cleafix'>
        <h2>Been to BRAVO TOURS? Share your experiences and BRAVO US</h2>
        <div class="cleafix">
            <div class='col-sm-2'>
        ...
        <div class='cleafix'>
            <div class='col-sm-10 col-sm-offset-2'>
                ...
                <div class="form-group">
                    <h2 style="display: inline">YOUR RATE ON OUR SERVICE</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name='departure_day' type="text" class="form-control" />
                         </div>
                    </div>
                </div>
                <div class="your"></div>      

...
<div id="tour-detail">
    <div class="row">
        ...
        <div class="col-sm-5">
            <ul class="list-unstyled list-inline" id="tour-detail-actions">
                ...
                <li><a class="" href="{{ route('tour.print', array($tour->area->slug, $tour->slug)) }}"><i class="fa fa-print"></i> PRINT THIS PAGE</a></li>
    ...
    <div class="row">
        <div class="col-sm-27">
            ...
            <div id="tour-staffs">
                <h4><a href="{{Request::root()}}/join-our-team">{{ $tour->area->name }} DESTINATION EXPERT</a></h4>
                <!-- Update here -->

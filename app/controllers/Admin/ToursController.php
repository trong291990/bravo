...
class ToursController extends AdminBaseController {
	...
	{
            $areas = \Area::all();
            $this->layout->content = View::make('admin.tours.create')->with('areas',$areas);
	}
	...
	public function edit($id)
	{
            ...
            $this->layout->content = View::make('admin.tours.edit')
                    ->with('areas',$areas)
                    ->with('tour',$tour)
	...
	public function update($id)
	{
            ...
            if($validator->passes()){
                ...
                return \Redirect::route('admin.tours.edit',array($tour->id));
            }else {
                Session::flash('error',"The tour has could not be save");
                return \Redirect::back()->withInput()->withErrors($validator->errors());
            }
